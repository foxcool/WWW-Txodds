...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.65' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "0.65"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.65">' > $(DISTNAME).ppd
